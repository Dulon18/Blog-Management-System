...
<body>
      ...
      @include('frontend.fixed.nav')<!-- End Header -->
        ...
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
                @foreach($posts_details as $details)
              <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>{{$details->created_at->formatLocalized('%A %e %B %Y')}}</span></div>
              <h1 class="mb-5">{{$details->tite}}</h1>
              <p><span class="firstcharacter">{{$details->title}}</span></p>

              <figure class="my-4">
                <img src="{{url('/uploads/'.$details->image)}}" alt="" class="img-fluid">
              ...
              <figure class="my-4">
                ...
                <figcaption>{{$details->tite}} </figcaption>
              </figure>
      
              <p>{{Str::limit($details->description,220) }}</p>
              <p>{{Str::limit($details->description,320) }}</p>
              @endforeach
             </div>
